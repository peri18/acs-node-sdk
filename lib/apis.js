...
Object.keys(acsObjects).forEach(function (acsObjectKey) {
	var acsObject = acsObjects[acsObjectKey],
		objectName = acsObject.objectName || acsObjectKey,
		baseMethodName = u.lowercaseFirstChar(objectName);

	acsObject.objectName || (acsObject.objectName = baseMethodName);
	...
	acsObject.methodList.forEach(function (acsObjectMethodKey) {
		...
		acsObject.methods[acsObjectMethodKey].apiMethodName = methodName;
